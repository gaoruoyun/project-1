  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(trademark,index) in trademarlList" :key="trademark.tmId" @click="tradeMatkHandler(trademark)">{{trademark.tmName}}</li>
...
import {mapGetters} from 'vuex'
  export default {
    name: 'SearchSelector',
    computed:{
      ...mapGetters(['trademarlList','attrsList'])
    },
    methods:{
      ...
      attrInfo(attr,attrValue){
        //["属性名":"属性值"]
        this.$emit("attrIfo",attr,attrValue)
      }
    }
  }
</script>
